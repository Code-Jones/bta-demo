...
const TrendArrow = ({ current, previous, trend }: TrendArrowProps) => {
    if (!trend) {
    ...
    switch (trend) {
        ...
        case 'down':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-rose-600">
