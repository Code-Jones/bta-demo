    ...
    <div className="bg-background-dark text-slate-200 font-display selection:bg-primary/30">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden" id="features">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="relative max-w-5xl mx-auto perspective-1000">
            <div className="glass p-4 rounded-2xl shadow-2xl rotate-x-12 transform-gpu border border-white/10 bg-gradient-to-br from-white/10 to-transparent">
      ...
      <div className="py-20 overflow-hidden select-none pointer-events-none">
        <div className="whitespace-nowrap flex">
          <span className="text-outline font-serif text-[120px] font-bold uppercase tracking-tighter mx-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8 group relative overflow-hidden rounded-3xl bg-slate-900 border border-white/5 p-12">
            ...
            <div className="relative z-20 h-full flex flex-col justify-end">
              <span className="text-primary font-bold tracking-widest uppercase text-xs mb-4">Fleet Intelligence</span>
              <h3 className="text-4xl font-serif text-white mb-6">Real-time GPS Dispatching</h3>
              <p className="text-slate-400 text-lg max-w-md mb-8">
                Route optimization that saves 15% on fuel costs and ensures your technicians arrive exactly
      ...
      <section className="py-24 relative overflow-hidden" id="pricing">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg">Scalable plans built for every stage of your trade business.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <PricingCard
              title="Starter"
              description="Essential tools for solo trades"
              price="$99"
              cta="Get Started"
              features={['Up to 2 Technicians', 'Basic Dispatching', 'Mobile Invoicing']}
            />
            <PricingCard
              title="Pro"
              description="Full pipeline and automation"
              price="$249"
              cta="Start Free Trial"
              highlight
              features={['Up to 15 Technicians', 'AI Route Optimization', 'Full CRM & Marketing', 'QuickBooks Integration']}
            />
            <PricingCard
              title="Enterprise"
              ...
              price="Custom"
              cta="Contact Sales"
              features={['Unlimited Technicians', 'Dedicated Success Manager', 'Custom API Access']}
            />
          </div>
        </div>
      </section>

      <section className="py-24 bg-white/[0.01]" id="enterprise">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex gap-8 overflow-x-auto hide-scrollbar pb-10">
            <TestimonialCard
              quote="Since switching to Contractor OS, our dispatch efficiency has increased by 40%. The real-time mapping is a game-changer for our technicians."
              name="Marcus Thorne"
              title="Master Plumber"
            />
            <TestimonialCard
              quote="The automated follow-ups have helped us close 25% more quotes than last year. It is like having a full-time office manager on autopilot."
              name="Elena Rodriguez"
              title="Electrical Contractor"
            />
            <TestimonialCard
              quote="Managing 12 vans used to be a nightmare. Now I can see exactly where parts are and how jobs are progressing from my phone."
              name="David Chen"
              title="HVAC Specialist"
            />
            <TestimonialCard
              quote="The integration with QuickBooks alone saved us 10 hours of manual data entry every week. Worth every penny."
              name="Sarah Jenkins"
              title="Roofing Operations Manager"
            />
          </div>
        </div>
      </section>
      ...
      <footer className="py-20 border-t border-white/5 bg-background-dark">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
            ...
            <FooterColumn
              title="Product"
              links={['Scheduling', 'Dispatch', 'Invoicing', 'CRM']}
            />
            <FooterColumn
              title="Company"
...
function PricingCard({
  ...
  return (
    <div
      className={`glass p-10 rounded-3xl flex flex-col border ${
        highlight ? 'border-2 border-primary relative' : 'border-white/10'
      }`}
    >
      {highlight ? (
...
function TestimonialCard({ quote, name, title }: { quote: string; name: string; title: string }) {
  return (
    <div className="min-w-[400px] glass p-8 rounded-3xl">
